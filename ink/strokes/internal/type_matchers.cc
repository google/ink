...
MATCHER_P(BrushTipStateEqMatcher, expected,
  ...
  return ExplainMatchResult(
      AllOf(Field("position", &BrushTipState::position,
            ...
            Field("chroma_multiplier", &BrushTipState::chroma_multiplier,
                  FloatEq(expected.chroma_multiplier)),
            Field("lightness_offset", &BrushTipState::lightness_offset,
                  FloatEq(expected.lightness_offset)),
...
MATCHER_P2(BrushTipStateNearMatcher, expected, tolerance,
  ...
  return ExplainMatchResult(
      AllOf(Field("position", &BrushTipState::position,
            ...
            Field("chroma_multiplier", &BrushTipState::chroma_multiplier,
                  FloatNear(expected.chroma_multiplier, tolerance)),
            Field("lightness_offset", &BrushTipState::lightness_offset,
                  FloatNear(expected.lightness_offset, tolerance)),
            Field("opacity_multiplier", &BrushTipState::opacity_multiplier,
...
MATCHER(ValidBrushTipStateMatcher,
  ...
  return ExplainMatchResult(
      AllOf(
          ...
          Field("paint_animation_progress_offset",
                &BrushTipState::paint_animation_progress_offset,
                AllOf(Ge(0), Le(2))),
          Field("hue_offset_in_full_turns",
...
MATCHER_P(ModeledStrokeInputEqMatcher, expected,
  ...
  return ExplainMatchResult(
      AllOf(Field("position", &ModeledStrokeInput::position,
            ...
            Field("barrel_twist", &ModeledStrokeInput::barrel_twist,
...
MATCHER_P2(ModeledStrokeInputNearMatcher, expected, tolerance,
  ...
  return ExplainMatchResult(
      AllOf(Field("position", &ModeledStrokeInput::position,
            ...
            Field("barrel_twist", &ModeledStrokeInput::barrel_twist,
                  NormalizedAngleNear(expected.barrel_twist, tolerance))),
      arg, result_listener);
}
