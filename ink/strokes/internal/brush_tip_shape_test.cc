...
TEST(BrushTipShapeTest, EvaluateTangentQualityTwoNonOverlappingCircles) {
  EXPECT_EQ(
      BrushTipShape::EvaluateTangentQuality(
...
TEST(BrushTipShapeTest, EvaluateTangentQualityTwoNonOverlappingSquares) {
  EXPECT_EQ(BrushTipShape::EvaluateTangentQuality(
                {{.position = {0, 0}, .width = 1, .height = 1}, kEpsilon},
                {{.position = {2, 1}, .width = 1, .height = 1}, kEpsilon}),
            BrushTipShape::TangentQuality::kGoodTangents);
}

TEST(BrushTipShapeTest, EvaluateTangentQualityTwoNonOverlappingStadiums) {
  EXPECT_EQ(
      BrushTipShape::EvaluateTangentQuality(
...
TEST(BrushTipShapeTest,
  ...
  EXPECT_EQ(BrushTipShape::EvaluateTangentQuality({{.position = {-1, 0},
                                                    .width = 1,
                                                    .height = 1,
                                                    .rotation = -kHalfPi,
                                                    .pinch = 0.5},
...
TEST(BrushTipShapeTest, JoinedShapeTwoPillsAtRightAngles) {
  EXPECT_EQ(
      BrushTipShape::EvaluateTangentQuality(
...
TEST(BrushTipShapeTest, EvaluateTangentQualityFirstShapeContainsSecond) {
  EXPECT_EQ(BrushTipShape::EvaluateTangentQuality(
                {{.position = {0, 0}, .width = 4, .height = 4}, kEpsilon},
                {{.position = {0.5, 0}, .width = 1, .height = 1}, kEpsilon}),
            BrushTipShape::TangentQuality::kNoTangentsFirstContainsSecond);
}

TEST(BrushTipShapeTest, EvaluateTangentQualitySecondShapeContainsFirst) {
  EXPECT_EQ(BrushTipShape::EvaluateTangentQuality(
                {{.position = {0.5, 0}, .width = 1, .height = 1}, kEpsilon},
                {{.position = {0, 0}, .width = 4, .height = 4}, kEpsilon}),
            BrushTipShape::TangentQuality::kNoTangentsSecondContainsFirst);
}
