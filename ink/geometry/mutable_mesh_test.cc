...
TEST(MutableMeshTest, ConstructWithFormat) {
  ...
  EXPECT_EQ(mesh.VertexPositionAttributeIndex(), 1);
  EXPECT_EQ(mesh.VertexStride(), 28);
...
TEST(MutableMeshTest, AppendVertex) {
  ...
  EXPECT_EQ(mesh.VertexPosition(0), (Point{3, 4}));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 1).Values(), ElementsAre(3, 4));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 2).Values(), ElementsAre(0));
}
...
TEST(MutableMeshTest, AppendMultipleVertices) {
  ...
  mesh.AppendVertex({-4, 2});
  mesh.AppendVertex({10, 100});

  EXPECT_EQ(mesh.VertexCount(), 4);
  EXPECT_EQ(mesh.VertexPosition(0), (Point{3, 4}));
  EXPECT_EQ(mesh.VertexPosition(1), (Point{1, 0}));
  EXPECT_EQ(mesh.VertexPosition(2), (Point{-4, 2}));
  EXPECT_EQ(mesh.VertexPosition(3), (Point{10, 100}));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 1).Values(), ElementsAre(3, 4));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 1).Values(), ElementsAre(1, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh.FloatVertexAttribute(2, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(2, 1).Values(), ElementsAre(-4, 2));
  EXPECT_THAT(mesh.FloatVertexAttribute(2, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh.FloatVertexAttribute(3, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(3, 1).Values(), ElementsAre(10, 100));
  EXPECT_THAT(mesh.FloatVertexAttribute(3, 2).Values(), ElementsAre(0));
}
...
TEST(MutableMeshTest, CloneEmptyMesh) {
  ...
  ASSERT_THAT(format, IsOk());
  MutableMesh mesh(*format);
  MutableMesh mesh2 = mesh.Clone();
  EXPECT_EQ(mesh2.VertexCount(), 0);
  EXPECT_EQ(mesh2.TriangleCount(), 0);
  EXPECT_THAT(mesh2.Format(), MeshFormatEq(*format));
  EXPECT_EQ(mesh2.VertexPositionAttributeIndex(), 1);
  EXPECT_EQ(mesh2.VertexStride(), 28);
  EXPECT_EQ(mesh2.IndexStride(), 2);
}
...
TEST(MutableMeshTest, ClonedEmptyMeshModificationsAreUnique) {
  ...
  mesh2.AppendVertex({1, 0});
  mesh2.AppendVertex({-4, 2});

  EXPECT_EQ(mesh.VertexCount(), 1);
  EXPECT_EQ(mesh.VertexPosition(0), (Point{3, 4}));
  EXPECT_EQ(mesh2.VertexCount(), 2);
  EXPECT_EQ(mesh2.VertexPosition(0), (Point{1, 0}));
  EXPECT_EQ(mesh2.VertexPosition(1), (Point{-4, 2}));
}
...
TEST(MutableMeshTest, CloneNonEmptyMesh) {
  ...
  MutableMesh mesh2 = mesh.Clone();
  EXPECT_EQ(mesh2.VertexCount(), 4);
  EXPECT_EQ(mesh2.VertexPosition(0), (Point{3, 4}));
  EXPECT_EQ(mesh2.VertexPosition(1), (Point{1, 0}));
  EXPECT_EQ(mesh2.VertexPosition(2), (Point{-4, 2}));
  EXPECT_EQ(mesh2.VertexPosition(3), (Point{10, 100}));
  EXPECT_THAT(mesh2.FloatVertexAttribute(0, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(0, 1).Values(), ElementsAre(3, 4));
  EXPECT_THAT(mesh2.FloatVertexAttribute(0, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(1, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(1, 1).Values(), ElementsAre(1, 0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(1, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(2, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(2, 1).Values(), ElementsAre(-4, 2));
  EXPECT_THAT(mesh2.FloatVertexAttribute(2, 2).Values(), ElementsAre(0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(3, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh2.FloatVertexAttribute(3, 1).Values(), ElementsAre(10, 100));
  EXPECT_THAT(mesh2.FloatVertexAttribute(3, 2).Values(), ElementsAre(0));
}
...
TEST(MutableMeshTest, ClonedNonEmptyMeshModificationsAreUnique) {
  ...
  EXPECT_EQ(mesh.VertexPosition(0), (Point{10, 100}));
  EXPECT_EQ(mesh.VertexPosition(1), (Point{3, 4}));
  EXPECT_EQ(mesh2.VertexCount(), 1);
  EXPECT_EQ(mesh2.VertexPosition(0), (Point{10, 100}));
...
TEST(MutableMeshTest, ResetEmptyMesh) {
  ...
  MutableMesh mesh;
  EXPECT_EQ(mesh.VertexCount(), 0);
  EXPECT_THAT(mesh.Format(), Not(MeshFormatEq(*format)));
...
TEST(MutableMeshTest, SetVertexPosition) {
  ...
  mesh.SetVertexPosition(1, {10, 20});
  mesh.SetVertexPosition(2, {20, 30});

  EXPECT_EQ(mesh.VertexCount(), 3);
  EXPECT_EQ(mesh.VertexPosition(1), (Point{10, 20}));
  EXPECT_EQ(mesh.VertexPosition(2), (Point{20, 30}));
}
...
TEST(MutableMeshTest, SetFloatVertexAttribute) {
  ...
  mesh.SetFloatVertexAttribute(0, 2, {5});
  mesh.SetFloatVertexAttribute(2, 0, {3, 4, 5, 6});

  EXPECT_THAT(mesh.FloatVertexAttribute(0, 2).Values(), ElementsAre(5));
  EXPECT_THAT(mesh.FloatVertexAttribute(2, 0).Values(),
              ElementsAre(3, 4, 5, 6));
}
...
TEST(MutableMeshTest, SetFloatVertexAttributeBytePacked) {
  ...
  mesh.AppendVertex({-1, 3});

  mesh.SetFloatVertexAttribute(0, 1, {9});

  EXPECT_EQ(mesh.VertexPosition(0), (Point{-1, 3}));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 1).Values(), ElementsAre(9));
}
...
TEST(MutableMeshTest, VertexAccessorsAlternateFormat) {
  ...
  mesh.AppendVertex({5, 10});
  mesh.SetFloatVertexAttribute(0, 1, {2, 4, 6});

  EXPECT_EQ(mesh.VertexPosition(0), (Point{5, 10}));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 1).Values(), ElementsAre(2, 4, 6));
}
...
TEST(MutableMeshTest, AppendMultipleTriangles) {
  ...
  mesh.AppendTriangleIndices({0, 1, 2});
  mesh.AppendTriangleIndices({3, 5, 7});
  mesh.AppendTriangleIndices({2, 3, 1});
  mesh.AppendTriangleIndices({4, 5, 7});

  EXPECT_EQ(mesh.TriangleCount(), 4);
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 5, 7));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(2, 3, 1));
  EXPECT_THAT(mesh.TriangleIndices(3), ElementsAre(4, 5, 7));
}
...
TEST(MutableMeshTest, SetTriangleIndices) {
  ...
  mesh.SetTriangleIndices(1, {7, 8, 9});

  EXPECT_EQ(mesh.TriangleCount(), 3);
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(7, 8, 9));
}
...
TEST(MutableMeshTest, InsertTriangleIndices) {
  ...
  mesh.InsertTriangleIndices(1, {7, 8, 9});

  EXPECT_EQ(mesh.TriangleCount(), 4);
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(7, 8, 9));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(3, 5, 7));
  EXPECT_THAT(mesh.TriangleIndices(3), ElementsAre(2, 3, 1));
}
...
TEST(MutableMeshTest, InsertTriangleIndicesAtEnd) {
  ...
  mesh.InsertTriangleIndices(2, {7, 8, 9});

  EXPECT_EQ(mesh.TriangleCount(), 3);
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 5, 7));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(7, 8, 9));
}
...
TEST(MutableMeshTest, ResizeEnlargingMesh) {
  ...
  mesh.AppendVertex({3, 4});
  mesh.SetFloatVertexAttribute(0, 0, {3, 4, 5, 6});
  mesh.SetFloatVertexAttribute(0, 2, {5});

  mesh.AppendTriangleIndices({0, 1, 2});
  mesh.AppendTriangleIndices({3, 5, 7});

  ASSERT_EQ(mesh.VertexCount(), 1);
  ...
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 0).Values(),
              ElementsAre(0, 0, 0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 1).Values(), ElementsAre(0, 0));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 2).Values(), ElementsAre(0));

  EXPECT_EQ(mesh.TriangleCount(), 4);
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 5, 7));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(0, 0, 0));
  EXPECT_THAT(mesh.TriangleIndices(3), ElementsAre(0, 0, 0));
}
...
TEST(MutableMeshTest, ResizeShrinkingMesh) {
  ...
  mesh.AppendVertex({3, 4});
  mesh.AppendVertex({1, 5});
  mesh.AppendVertex({-4, 2});
  mesh.SetFloatVertexAttribute(0, 2, {5});
  mesh.SetFloatVertexAttribute(1, 2, {8});
  mesh.SetFloatVertexAttribute(2, 0, {3, 4, 5, 6});
  ...
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 1).Values(), ElementsAre(3, 4));
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 2).Values(), ElementsAre(5));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 1).Values(), ElementsAre(1, 5));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 2).Values(), ElementsAre(8));
...
TEST(MutableMeshTest, ValidateTrianglesValidCase) {
  ...
  mesh.AppendVertex({0, 1});
  mesh.AppendVertex({1, 1});
  mesh.AppendVertex({2, 1});
  mesh.AppendTriangleIndices({0, 4, 3});
  mesh.AppendTriangleIndices({0, 1, 4});
  mesh.AppendTriangleIndices({1, 5, 4});
  mesh.AppendTriangleIndices({1, 2, 5});

  EXPECT_THAT(mesh.ValidateTriangles(), IsOk());
}
...
TEST(MutableMeshTest, ValidateTrianglesNonExistentVertex) {
  ...
  mesh.AppendTriangleIndices({0, 4, 3});
  mesh.AppendTriangleIndices({0, 1, 4});
  mesh.AppendTriangleIndices({1, 6, 4});
  mesh.AppendTriangleIndices({1, 2, 5});

  EXPECT_THAT(mesh.ValidateTriangles(),
...
TEST(MutableMeshTest, ValidateTrianglesAllowsTrianglesWithNegativeArea) {
  ...
  mesh.AppendTriangleIndices({0, 4, 3});
  mesh.AppendTriangleIndices({0, 1, 4});
  mesh.AppendTriangleIndices({1, 4, 5});
  mesh.AppendTriangleIndices({1, 2, 5});
...
TEST(MutableMeshTest, ValidateTrianglesRepeatedVertex) {
  ...
  mesh.AppendTriangleIndices({0, 4, 3});
  mesh.AppendTriangleIndices({0, 1, 4});
  mesh.AppendTriangleIndices({1, 4, 4});
  mesh.AppendTriangleIndices({1, 2, 5});
...
TEST(MutableMeshTest, GetTriangle) {
  ...
  mesh.AppendVertex({1, 1});
  mesh.AppendTriangleIndices({0, 1, 2});
  mesh.AppendTriangleIndices({1, 3, 2});

  EXPECT_EQ(mesh.GetTriangle(0),
            (Triangle{.p0 = {0, 0}, .p1 = {1, 0}, .p2 = {0, 1}}));
  EXPECT_EQ(mesh.GetTriangle(1),
...
TEST(MutableMeshTest, TriangleAccessorsAlternateFormat) {
  ...
  mesh.AppendVertex({1, 1});
  mesh.AppendVertex({3, 1});

  mesh.AppendTriangleIndices({0, 1, 3});
  mesh.AppendTriangleIndices({1, 2, 5});
  mesh.InsertTriangleIndices(1, {1, 4, 3});
  mesh.SetTriangleIndices(2, {1, 2, 4});

  EXPECT_EQ(mesh.TriangleCount(), 3);
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 3));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(1, 4, 3));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(1, 2, 4));
  EXPECT_EQ(mesh.GetTriangle(0),
            (Triangle{.p0 = {0, 0}, .p1 = {2, 0}, .p2 = {1, 1}}));
  EXPECT_EQ(mesh.GetTriangle(1),
            (Triangle{.p0 = {2, 0}, .p1 = {3, 1}, .p2 = {1, 1}}));
  EXPECT_EQ(mesh.GetTriangle(2),
...
TEST(MutableMeshTest, RawVertexDataWhenEmpty) {
  MutableMesh mesh;
  EXPECT_TRUE(mesh.RawVertexData().empty());
}

TEST(MutableMeshTest, RawVertexDataWhenNonEmpty) {
  MutableMesh mesh;
  mesh.AppendVertex({4, 9});
  std::vector<std::byte> vertex_byte_data_1 = CopyToBytes<float>({4, 9});
  EXPECT_THAT(mesh.RawVertexData(), ElementsAreArray(vertex_byte_data_1));

  mesh.AppendVertex({3, 5});
  std::vector<std::byte> vertex_byte_data_2 = CopyToBytes<float>({4, 9, 3, 5});
  EXPECT_THAT(mesh.RawVertexData(), ElementsAreArray(vertex_byte_data_2));
}
...
TEST(MutableMeshTest, RawVertexDataWhenNonEmptyWithDifferentFormat) {
  ...
  mesh.SetFloatVertexAttribute(0, 0, {3, 4, 5, 6});
  mesh.SetFloatVertexAttribute(1, 2, {2});
...
TEST(MutableMeshTest, RawIndexDataWhenEmpty) {
  MutableMesh mesh;
  EXPECT_TRUE(mesh.RawIndexData().empty());
}
...
TEST(MutableMeshTest, RawIndexDataWhenNonEmpty) {
  ...
  EXPECT_THAT(mesh.RawIndexData(), ElementsAreArray(index_byte_data_1));

  mesh.AppendTriangleIndices({1, 3, 2});
  std::vector<std::byte> index_byte_data_2 =
      CopyToBytes<uint32_t>({0, 1, 2, 1, 3, 2});
  EXPECT_THAT(mesh.RawIndexData(), ElementsAreArray(index_byte_data_2));
}
...
TEST(MutableMeshtest, AsMeshesEmptyWithFormat) {
  absl::StatusOr<MeshFormat> format =
      MeshFormat::Create({{MeshFormat::AttributeType::kFloat4PackedInOneFloat,
                         ...
                         MeshFormat::IndexFormat::k16BitUnpacked16BitPacked);
  ASSERT_THAT(format, IsOk());
  EXPECT_THAT(MutableMesh(*format).AsMeshes(), IsOkAndHolds(IsEmpty()));
}

TEST(MutableMeshTest, AsMeshesDefaultFormat) {
  MutableMesh mutable_mesh;
  mutable_mesh.AppendVertex({0, 0});
  mutable_mesh.AppendVertex({2, 0});
  mutable_mesh.AppendVertex({1, 1});
  mutable_mesh.AppendVertex({3, 2});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({1, 3, 2});
  ...
  EXPECT_THAT(mesh.VertexPosition(0), PointEq({0, 0}));
  EXPECT_THAT(mesh.VertexPosition(1), PointEq({2, 0}));
  EXPECT_THAT(mesh.VertexPosition(2), PointEq({1, 1}));
  EXPECT_THAT(mesh.VertexPosition(3), PointEq({3, 2}));
  EXPECT_THAT(mesh.Bounds(), EnvelopeEq(Rect::FromTwoPoints({0, 0}, {3, 2})));
  EXPECT_THAT(
      mesh.AttributeBounds(0),
      Optional(MeshAttributeBoundsEq({.minimum = {0, 0}, .maximum = {3, 2}})));

  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(1, 3, 2));
}
...
TEST(MutableMeshTest, AsMeshesCustomFormat) {
  ...
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({1, 3, 2});
  mutable_mesh.SetFloatVertexAttribute(0, 0, {1, 0, 0, 1});
  mutable_mesh.SetFloatVertexAttribute(1, 0, {0, 1, 0, 1});
  mutable_mesh.SetFloatVertexAttribute(2, 0, {0, 0, 1, 1});
  mutable_mesh.SetFloatVertexAttribute(3, 0, {0.5, 0.5, 0.5, 0.5});
  mutable_mesh.SetFloatVertexAttribute(0, 2, {5});
  mutable_mesh.SetFloatVertexAttribute(1, 2, {15});
  mutable_mesh.SetFloatVertexAttribute(2, 2, {-5});
  mutable_mesh.SetFloatVertexAttribute(3, 2, {25});
  ...
  EXPECT_THAT(mesh.VertexPosition(0), PointNear({0, 0}, 3.67e-4));
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({2, 0}, 3.67e-4));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({1, 1}, 3.67e-4));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({3, 2}, 3.67e-4));
  EXPECT_THAT(mesh.Bounds(),
              EnvelopeNear(Rect::FromTwoPoints({0, 0}, {3, 2}), 3.67e-4));
  EXPECT_THAT(mesh.AttributeBounds(1),
  ...
  EXPECT_THAT(mesh.FloatVertexAttribute(0, 2).Values(), ElementsAre(5));
  EXPECT_THAT(mesh.FloatVertexAttribute(1, 2).Values(), ElementsAre(15));
  EXPECT_THAT(mesh.FloatVertexAttribute(2, 2).Values(), ElementsAre(-5));
  EXPECT_THAT(mesh.FloatVertexAttribute(3, 2).Values(), ElementsAre(25));
  EXPECT_THAT(
      mesh.AttributeBounds(2),
...
TEST(MutableMeshTest, AsMeshesExcludesUnusedVertices) {
  ...
  mutable_mesh.AppendVertex({1, -1});
  mutable_mesh.AppendVertex({2, 0});
  mutable_mesh.AppendVertex({3, -1});
  mutable_mesh.AppendVertex({4, 0});
  mutable_mesh.AppendVertex({1, 1});
  mutable_mesh.AppendVertex({3, 1});
  mutable_mesh.AppendTriangleIndices({0, 2, 5});
  mutable_mesh.AppendTriangleIndices({2, 6, 5});
  mutable_mesh.AppendTriangleIndices({2, 4, 6});
  ...
  EXPECT_THAT(mesh.Format(), MeshFormatEq(MeshFormat()));
  ASSERT_EQ(mesh.VertexCount(), 5);
  ASSERT_EQ(mesh.TriangleCount(), 3);
  ...
  EXPECT_THAT(mesh.VertexPosition(1), PointEq({2, 0}));
  EXPECT_THAT(mesh.VertexPosition(2), PointEq({1, 1}));
  EXPECT_THAT(mesh.VertexPosition(3), PointEq({3, 1}));
  EXPECT_THAT(mesh.VertexPosition(4), PointEq({4, 0}));
  EXPECT_THAT(mesh.Bounds(), EnvelopeEq(Rect::FromTwoPoints({0, 0}, {4, 1})));
  EXPECT_THAT(
      mesh.AttributeBounds(0),
  ...
  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(1, 3, 2));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(1, 4, 3));
}
...
TEST(MutableMeshTest, AsMeshes16BitReturnsMultiplePartitionsForLargeMesh) {
  ...
  MutableMesh mutable_mesh = MakeStraightLineMutableMesh(1e5);

  // The resulting meshes will still be triangle strips, and so will have two
  // more vertices than triangles.
  absl::StatusOr<absl::InlinedVector<Mesh, 1>> meshes = mutable_mesh.AsMeshes();
  ASSERT_THAT(meshes, IsOkAndHolds(SizeIs(2)));
  const Mesh& mesh1 = (*meshes)[0];
  const Mesh& mesh2 = (*meshes)[1];

  EXPECT_THAT(mesh1.Format(), MeshFormatEq(MeshFormat()));
  EXPECT_THAT(mesh2.Format(), MeshFormatEq(MeshFormat()));
  // The first mesh has the maximum number of vertices (2^16).
  EXPECT_EQ(mesh1.VertexCount(), 65536);
  EXPECT_EQ(mesh1.TriangleCount(), 65534);
  EXPECT_THAT(mesh1.Bounds(),
              EnvelopeEq(Rect::FromTwoPoints({0, -1}, {65535, 0})));
  // The second mesh has the remainder, plus two that overlap
  // ((1e5 + 2) - 2^16 + 2).
  EXPECT_EQ(mesh2.VertexCount(), 34468);
  EXPECT_EQ(mesh2.TriangleCount(), 34466);
  EXPECT_THAT(mesh2.Bounds(),
...
TEST(MutableMeshTest, AsMeshesPartitionsUseSameUnpackingParams) {
  ...
  EXPECT_THAT(mesh1.VertexAttributeUnpackingParams(0),
              MeshAttributeCodingParamsEq(expected_unpacking_params));
  EXPECT_THAT(mesh2.VertexAttributeUnpackingParams(0),
              MeshAttributeCodingParamsEq(expected_unpacking_params));
}
...
TEST(MutableMeshTest, AsMeshes16BitMultiplePartitionsPreservesMinimumBounds) {
  ...
  // partition.
  mutable_mesh.AppendVertex({-100, -100});
  mutable_mesh.AppendTriangleIndices({mutable_mesh.VertexCount() - 1, 1, 0});
...
TEST(MutableMeshTest, AsMeshesWithCustomPackingParams) {
  ...
  ASSERT_THAT(mesh.Format(), MeshFormatEq(*format));
  ASSERT_EQ(mesh.VertexCount(), 4);
  ASSERT_EQ(mesh.TriangleCount(), 2);
  ...
  EXPECT_THAT(mesh.VertexAttributeUnpackingParams(0),
              MeshAttributeCodingParamsEq({{{.offset = -1.1, .scale = .1},
                                            ...
                                            {.offset = -1.3, .scale = .1},
                                            {.offset = -1.4, .scale = .1}}}));
  EXPECT_THAT(mesh.VertexAttributeUnpackingParams(1),
              MeshAttributeCodingParamsEq({{{.offset = -5, .scale = .01},
                                            {.offset = -4, .scale = .05}}}));
  EXPECT_THAT(mesh.VertexAttributeUnpackingParams(2),
...
TEST(MutableMeshTest,
  ...
  EXPECT_THAT(
      mesh.VertexAttributeUnpackingParams(1),
  ...
  EXPECT_THAT(mesh.VertexPosition(0), PointNear({0, 0}, 3.67e-4, 2.45e-4));
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({2, 0}, 3.67e-4, 2.45e-4));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({1, 1}, 3.67e-4, 2.45e-4));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({3, 2}, 3.67e-4, 2.45e-4));
...
TEST(MutableMeshTest, AsMeshesFailsIfNonExistentVertexIsReferenced) {
  ...
  EXPECT_THAT(mutable_mesh.AsMeshes(),
              StatusIs(absl::StatusCode::kFailedPrecondition,
                       HasSubstr("non-existent vertex")));
}
...
TEST(MutableMeshTest, AsMeshesAllowsTrianglesWithNegativeArea) {
  ...
  mutable_mesh.AppendVertex({3, 2});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({1, 2, 3});

  EXPECT_THAT(mutable_mesh.AsMeshes(), IsOk());
}
...
TEST(MutableMeshTest, AsMeshesRejectsNonFiniteValues) {
  ...
  EXPECT_THAT(baseline.AsMeshes(), IsOk());
  EXPECT_THAT(with_infinite_attr.AsMeshes(),
              StatusIs(absl::StatusCode::kFailedPrecondition,
                       HasSubstr("non-finite value")));
  EXPECT_THAT(with_nan_attr.AsMeshes(),
              StatusIs(absl::StatusCode::kFailedPrecondition,
                       HasSubstr("non-finite value")));
  EXPECT_THAT(with_non_finite_unpacked_value.AsMeshes(),
              StatusIs(absl::StatusCode::kFailedPrecondition,
                       HasSubstr("non-finite value")));
  EXPECT_THAT(with_finite_values_but_infinite_bounds.AsMeshes(),
...
TEST(MutableMeshTest, AsMeshesCorrectsSingleFlippedTriangle) {
  ...
  MutableMesh mutable_mesh(MakeSinglePackedPositionFormat());
  mutable_mesh.AppendVertex({0, 0});
  mutable_mesh.AppendVertex({4095, 0});
  mutable_mesh.AppendVertex({4095, 4095});
  mutable_mesh.AppendVertex({0.4, 0.6});
  mutable_mesh.AppendVertex({3967.4, 4094.6});
  mutable_mesh.AppendVertex({793.73, 819.47});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({3, 4, 5});  // Flipped
  ...
  EXPECT_THAT(mesh.VertexPosition(0), PointNear({0, 0}, kTol));
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({4095, 0}, kTol));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({4095, 4095}, kTol));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({0.4, 0.6}, kTol));
  EXPECT_THAT(mesh.VertexPosition(4), PointNear({3967.4, 4094.6}, kTol));
  EXPECT_THAT(mesh.VertexPosition(5), PointNear({793.73, 819.47}, kTol));

  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 4, 5));

  EXPECT_THAT(mesh, MeshTrianglesHaveNonNegativeArea());
}
...
TEST(MutableMeshTest, AsMeshesCorrectsSingleFlippedTriangleWithNonUnitScale) {
  ...
  mutable_mesh.AppendVertex({0, 0});
  mutable_mesh.AppendVertex({2047.5, 0});
  mutable_mesh.AppendVertex({2047.5, 8190});
  mutable_mesh.AppendVertex({0.2, 1.2});
  mutable_mesh.AppendVertex({1983.7, 8189.2});
  mutable_mesh.AppendVertex({396.865, 1638.94});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({3, 4, 5});  // Flipped
  ...
  EXPECT_THAT(mesh.VertexPosition(0), PointNear({0, 0}, .5, 2));
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({2047.5, 0}, .5, 2));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({2047.5, 8190}, .5, 2));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({0.2, 1.2}, .5, 2));
  EXPECT_THAT(mesh.VertexPosition(4), PointNear({1983.7, 8189.2}, .5, 2));
  EXPECT_THAT(mesh.VertexPosition(5), PointNear({396.865, 1638.94}, .5, 2));
...
TEST(MutableMeshTest, AsMeshesMultipleFlippedTrianglesWithSharedVertices) {
  ...
  mutable_mesh.AppendVertex({4095, 0});
  mutable_mesh.AppendVertex({4095, 4095});
  mutable_mesh.AppendVertex({2358.52, 3913.05});
  mutable_mesh.AppendVertex({255.948, 424.528});
  mutable_mesh.AppendVertex({1668.59, 2436.19});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({3, 0, 4});  // Flipped
  mutable_mesh.AppendTriangleIndices({5, 4, 0});
  mutable_mesh.AppendTriangleIndices({5, 3, 0});
  ...
  ASSERT_EQ(mesh.VertexCount(), 6);
  ASSERT_EQ(mesh.TriangleCount(), 4);

  EXPECT_THAT(mesh.VertexPosition(0), PointNear({0, 0}, kTol));
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({4095, 0}, kTol));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({4095, 4095}, kTol));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({2358.52, 3913.05}, kTol));
  EXPECT_THAT(mesh.VertexPosition(4), PointNear({255.948, 424.528}, kTol));
  EXPECT_THAT(mesh.VertexPosition(5), PointNear({1668.59, 2436.19}, kTol));

  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 0, 4));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(5, 4, 0));
  EXPECT_THAT(mesh.TriangleIndices(3), ElementsAre(5, 3, 0));
...
TEST(MutableMeshTest, AsMeshesCorrectsMultipleTrianglesWithOneNudge) {
  ...
  mutable_mesh.AppendVertex({4095, 0});
  mutable_mesh.AppendVertex({4095, 4095});
  mutable_mesh.AppendVertex({997.73, 678.97});
  mutable_mesh.AppendVertex({1424.83, 1273.84});
  mutable_mesh.AppendVertex({1696.56, 1652.68});
  mutable_mesh.AppendVertex({1747.14, 1133.63});
  mutable_mesh.AppendVertex({1767.93, 1146.35});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({3, 4, 5});  // Flipped
  mutable_mesh.AppendTriangleIndices({6, 7, 3});  // Flipped
  ...
  EXPECT_THAT(mesh.VertexPosition(1), PointNear({4095, 0}, kTol));
  EXPECT_THAT(mesh.VertexPosition(2), PointNear({4095, 4095}, kTol));
  EXPECT_THAT(mesh.VertexPosition(3), PointNear({997.73, 678.97}, kTol));
  EXPECT_THAT(mesh.VertexPosition(4), PointNear({1424.83, 1273.84}, kTol));
  EXPECT_THAT(mesh.VertexPosition(5), PointNear({1696.56, 1652.68}, kTol));
  EXPECT_THAT(mesh.VertexPosition(6), PointNear({1747.14, 1133.63}, kTol));
  EXPECT_THAT(mesh.VertexPosition(7), PointNear({1767.93, 1146.35}, kTol));

  EXPECT_THAT(mesh.TriangleIndices(0), ElementsAre(0, 1, 2));
  EXPECT_THAT(mesh.TriangleIndices(1), ElementsAre(3, 4, 5));
  EXPECT_THAT(mesh.TriangleIndices(2), ElementsAre(6, 7, 3));
...
TEST(MutableMeshTest,
  ...
  mutable_mesh.AppendVertex({-1, 1});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({1, 0, 2});

  // `AsMeshes` will succeed, but the result still contain flipped triangles.
  auto meshes = mutable_mesh.AsMeshes();
...
TEST(MutableMeshTest, AsMeshesFlippedTrianglesFailureCase) {
  ...
  mutable_mesh.AppendVertex({4095, 0});
  mutable_mesh.AppendVertex({4095, 4095});
  mutable_mesh.AppendVertex({225.634, 2038.04});
  mutable_mesh.AppendVertex({233.615, 2038.78});
  mutable_mesh.AppendVertex({3928.94, 2247.34});
  mutable_mesh.AppendVertex({1978, 2231.02});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({6, 3, 4});  // Flipped
  mutable_mesh.AppendTriangleIndices({4, 3, 5});
...
TEST(MutableMeshTest,
  ...
  mutable_mesh.AppendVertex({1978, 2231.02});
  mutable_mesh.AppendTriangleIndices({0, 1, 2});
  mutable_mesh.AppendTriangleIndices({6, 3, 4});
  mutable_mesh.AppendTriangleIndices({4, 3, 5});

  // `AsMeshes` will succeed, but the result still contain flipped triangles.
  constexpr float kScale = 4095.f / 3974;
  auto meshes = mutable_mesh.AsMeshes({MeshAttributeCodingParams{
...
TEST(MutableMeshTest, AddMeshesPositionOmittedIsError) {
  ...
  mesh.AppendVertex({0, 0});
  mesh.AppendVertex({4, 0});
  mesh.AppendVertex({0, 3});
  mesh.AppendTriangleIndices({0, 1, 2});

  EXPECT_THAT(mesh.AsMeshes({}, {MeshFormat::AttributeId::kPosition}),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST(MutableMeshTest, AsMeshesFuzzFailureb295270747) {
  // This is the reduced case from b/295270747, with unused vertices removed.
  MutableMesh mesh(MakeSinglePackedPositionFormat());
  mesh.AppendVertex({-1, 1});
  mesh.AppendVertex({0, -2435.0625});
  mesh.AppendVertex({0.98450989, 0});
  mesh.AppendVertex({0, 0.46548146});
  mesh.AppendTriangleIndices({2, 0, 3});
  mesh.AppendTriangleIndices({2, 0, 1});

  // This was previously CHECK-failing due to an error in bounds calculation.
  auto meshes = mesh.AsMeshes();
  ASSERT_THAT(meshes, IsOk());
...
TEST(MutableMeshTest, AsMeshesFuzzFailureb294848324) {
  ...
  MutableMesh mesh(MakeSinglePackedPositionFormat());
  mesh.AppendVertex({-1, 1});
  mesh.AppendVertex({0.031326283, 0});
  mesh.AppendVertex({-0, 0.31641644});
  mesh.AppendVertex({1, -1});
  mesh.AppendVertex({0, -10957.781});
  mesh.AppendVertex({0, 0.46548146});
  mesh.AppendTriangleIndices({1, 3, 5});
  mesh.AppendTriangleIndices({0, 4, 2});
...
TEST(MutableMeshDeathTest, VertexIndexOutOfBounds) {
  ...
  EXPECT_DEATH_IF_SUPPORTED(mesh.VertexPosition(3), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.SetVertexPosition(3, {5, 6}), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.FloatVertexAttribute(3, 0), "");
  EXPECT_DEATH_IF_SUPPORTED(
      mesh.SetFloatVertexAttribute(3, 0, SmallArray<float, 4>({1})), "");
#else
...
TEST(MutableMeshDeathTest, AttributeIndexOutOfBounds) {
  ...
  EXPECT_DEATH_IF_SUPPORTED(mesh.FloatVertexAttribute(1, 3), "");
  EXPECT_DEATH_IF_SUPPORTED(
      mesh.SetFloatVertexAttribute(1, 3, SmallArray<float, 4>({1})), "");
#else
  GTEST_SKIP() << "This tests behavior that is disabled in opt builds.";
#endif
}
...
TEST(MutableMeshDeathTest, WrongNumberOfComponentsForAttribute) {
  ...
  EXPECT_DEATH_IF_SUPPORTED(
      mesh.SetFloatVertexAttribute(1, 1, SmallArray<float, 4>({1, 2, 3})), "");
#else
  GTEST_SKIP() << "This tests behavior that is disabled in opt builds.";
#endif
}
...
TEST(MutableMeshDeathTest, TriangleIndexOutOfBounds) {
  ...
  mesh.AppendVertex({1, 2});
  mesh.AppendVertex({3, 4});
  mesh.AppendVertex({5, 6});
  mesh.AppendVertex({0, 4});
  mesh.AppendTriangleIndices({0, 1, 3});
  mesh.AppendTriangleIndices({0, 2, 3});

  EXPECT_DEATH_IF_SUPPORTED(mesh.TriangleIndices(2), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.SetTriangleIndices(2, {1, 2, 3}), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.InsertTriangleIndices(3, {1, 2, 3}), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.GetTriangle(2), "");
#else
  GTEST_SKIP() << "This tests behavior that is disabled in opt builds.";
#endif
}
...
TEST(MutableMeshDeathTest, TriangleVertexIndexNotRepresentable) {
  ...
  EXPECT_DEATH_IF_SUPPORTED(mesh.AppendTriangleIndices(bad_indices), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.SetTriangleIndices(0, bad_indices), "");
  EXPECT_DEATH_IF_SUPPORTED(mesh.InsertTriangleIndices(1, bad_indices), "");
#else
  GTEST_SKIP() << "This tests behavior that is disabled in opt builds.";
#endif
}
...
TEST(MutableMeshDeathTest, TriangleVertexIndexOutOfBounds) {
  ...
  EXPECT_DEATH_IF_SUPPORTED(mesh.GetTriangle(0), "");
#else
  GTEST_SKIP() << "This tests behavior that is disabled in opt builds.";
#endif
}
