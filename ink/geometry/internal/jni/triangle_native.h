...
#ifndef INK_GEOMETRY_INTERNAL_JNI_TRIANGLE_NATIVE_H_
#define INK_GEOMETRY_INTERNAL_JNI_TRIANGLE_NATIVE_H_
...
#endif  // INK_GEOMETRY_INTERNAL_JNI_TRIANGLE_NATIVE_H_
