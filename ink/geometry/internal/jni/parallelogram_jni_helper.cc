...
jobject CreateJImmutableParallelogramOrThrow(JNIEnv* env, const Quad& quad) {
  ...
  return env->CallStaticObjectMethod(
      ClassImmutableParallelogram(),
      MethodImmutableParallelogramFromCenterDimRotShear(), center, quad.Width(),
      quad.Height(), quad.Rotation().ValueInRadians(), quad.ShearFactor());
}
...
void FillJMutableParallelogramOrThrow(JNIEnv* env, const Quad& quad,
  ...
  env->CallVoidMethod(
      ...
      MethodMutableParallelogramSetCenterDimensionsRotationAndShear(),
